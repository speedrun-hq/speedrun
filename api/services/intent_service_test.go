...
func (m *MockDatabase) ListIntentsBySender(ctx context.Context, sender string) ([]*models.Intent, error) {
...
func (m *MockDatabase) ListIntentsBySenderPaginated(ctx context.Context, sender string, page, pageSize int) ([]*models.Intent, int, error) {
...
func (m *MockDatabase) ListIntentsByRecipient(ctx context.Context, recipient string) ([]*models.Intent, error) {
...
func (m *MockDatabase) ListIntentsByRecipientPaginated(ctx context.Context, recipient string, page, pageSize int) ([]*models.Intent, int, error) {
