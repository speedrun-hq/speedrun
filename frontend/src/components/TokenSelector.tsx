  ...
  return (
    <div className="relative w-full">
      <select
        ...
        className="w-full px-4 py-2 bg-black border-2 border-yellow-500 rounded-lg text-yellow-500 arcade-text text-xs focus:outline-none focus:border-yellow-400"
      >
        {tokens.map((token) => (
