...
const PendingAnimation: React.FC<PendingAnimationProps> = ({
  approvalHash,
}) => {
  ...
  const scrollingGround =
    groundPattern.substring(groundPosition) +
    groundPattern.substring(0, groundPosition);
    ...
    <div className="flex flex-col items-center my-4">
      <div className="border-2 border-yellow-500 bg-black p-4 w-full max-w-sm overflow-hidden">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-yellow-500 text-xs arcade-text blink">
            PLEASE WAIT
          </span>
        </div>
